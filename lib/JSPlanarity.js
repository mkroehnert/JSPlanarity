...
window.JSPlanarity = (function(raphaelCanvas, configuration) {
    /**
    ...
    function createFactories(raphaelCanvas) {
        ...
        function createVertex(xpos, ypos) {
             ...
             */
            var vertexVisualisation = raphaelCanvas.circle(xpos || configuration.xSize / 2,
    ...
    function init(divName) {
        ...
        createNewGraph(configuration.difficulty);
    }
    ...
    function checkEdgeIntersection() {
        ...
        if (0 < intersections.length)
            ...
            alert('Congratulations: You WON Stage ' + (configuration.difficulty - 3));
